...
$('#cityB').on('click', function () {
  ...
  $.ajax({
    ...
    error: function (e) {
      console.log('Error');
      $('#cityC').html(
        '<p style="color:red";>ERROR</p><p style="color:#bef7f1";>Проверьте корректность названия</p>'
      );
  ...
  function dataHandler3(data) {
    ...
    document.getElementById('demo4').innerHTML =
      'Макс.' +
      ' ' +
      Math.floor(data.list[num + 3].main['temp'] - 273, 15) +
      '°C';
    document.getElementById('demo7').innerHTML = data.list[num].dt_txt;
    document.getElementById('demo5').innerHTML =
      'Мин.' + ' ' + Math.floor(data.list[num].main['temp'] - 273, 15) + '°C';
    var imgURL =
      'https://openweathermap.org/img/w/' +
      data.list[num + 3].weather[0].icon +
      '.png';
    ...
    document.getElementById('demo9').innerHTML =
      'Макс. ' +
      ' ' +
      Math.floor(data.list[num + 11].main['temp'] - 273, 15) +
      '°C';
    document.getElementById('demo10').innerHTML = data.list[num + 8].dt_txt;
    document.getElementById('demo11').innerHTML =
      'Мин.' +
      ' ' +
      Math.floor(data.list[num + 9].main['temp'] - 273, 15) +
      '°C';
    var imgURL =
      'https://openweathermap.org/img/w/' +
      data.list[num + 11].weather[0].icon +
      '.png';
    ...
    document.getElementById('demo13').innerHTML =
      'Макс.' +
      ' ' +
      Math.floor(data.list[num + 19].main['temp'] - 273, 15) +
      '°C';
    document.getElementById('demo14').innerHTML = data.list[num + 16].dt_txt;
    document.getElementById('demo15').innerHTML =
      'Мин.' +
      ' ' +
      Math.floor(data.list[num + 17].main['temp'] - 273, 15) +
      '°C';
    var imgURL =
      'https://openweathermap.org/img/w/' +
      data.list[num + 19].weather[0].icon +
      '.png';
    ...
    document.getElementById('demo17').innerHTML =
      'Макс.' +
      ' ' +
      Math.floor(data.list[num + 27].main['temp'] - 273, 15) +
      '°C';
    document.getElementById('demo18').innerHTML = data.list[num + 24].dt_txt;
    document.getElementById('demo19').innerHTML =
      'Мин.' +
      ' ' +
      Math.floor(data.list[num + 25].main['temp'] - 273, 15) +
      '°C';
    var imgURL =
      'https://openweathermap.org/img/w/' +
      data.list[num + 27].weather[0].icon +
      '.png';
